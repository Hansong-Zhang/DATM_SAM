...
from utils.utils_sam import Logger
import copy
...
def main(args):
    ...
    trainloader = torch.utils.data.DataLoader(dst_train, batch_size=args.batch_train, shuffle=True, num_workers=8)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs_dir', type=str, default='data', help='logs path')
    parser.add_argument('--dataset', type=str, default='CIFAR10', help='dataset')
    parser.add_argument('--subset', type=str, default='imagefruit', help='subset')
    parser.add_argument('--res', type=int, default=128, help='resolution of imagenet')
    ...
    sys.stdout = Logger(os.path.join(args.logs_dir, '{}_res{}_model{}.log'.format(args.subset, args.res, args.model)))
    main(args)
